		...
		if($item == 1 && get_field('first_open') ){
			...
			<div class="st_accordion-item <?php echo $open ?>">
				<div class="st_accordion-header">
					<?php echo $accordion_title; ?><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-down"><polyline points="6 9 12 15 18 9"></polyline></svg>
				</div>
